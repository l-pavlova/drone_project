// Launcher for scripts/quickstart.sh — exists only to find a REAL bash.
//
...
const script = join(here, "quickstart.sh");
...
const child = spawn(findBash(), [script, ...process.argv.slice(2)], {
  stdio: "inherit",
  windowsHide: false,
});
