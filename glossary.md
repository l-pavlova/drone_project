...
- подобряване на света - тревички сгради
- ако има ремонт смяна на маршрута в графа махане на ребра и тн
- физически експеримент тук на паркинга 
- алгоритъма да стане с истински данни
- модем за интернета
- за разберито втори gps за да се предават данни за снимката, час, локация
- симулацията да връща същия формат снимки 
- gradska mobilnost imat kamera 